...
window.SeniorEaseMedicines = {
  ...
  async addMedicine(e){
    ...
    await SeniorEaseAPI.api("/medicines",{method:"POST",body:JSON.stringify({user_id:uid,name:medNameInput.value,dosage:medDosageInput.value,timing:slot,schedule_times:[times[slot]]})});
