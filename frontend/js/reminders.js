...
window.SeniorEaseReminders = {
  ...
  addReminder(e){e.preventDefault();this.reminders.push({title:remindTitleInput.value,type:remindTypeSelect.value,date:remindDateInput.value,time:remindTimeInput.value});localStorage.setItem("seniorEaseReminders",JSON.stringify(this.reminders));SeniorEaseApp.closeModal("modalAddReminder");this.render();SeniorEaseApp.showToast("Reminder saved.");},
